...
encrypt_fpath = "C:\Program Files (x86)\\TextFortress\\ENCRYPT\\Encrypt_main.py"
decrypt_fpath = "C:\Program Files (x86)\\TextFortress\\DECRYPT\\Decrypt_main.py"
...
def decrypt_and_save():
    ...
    if os.path.exists(file_path):
        ...
        # Verify the key
        keypath = "C:\Program Files (x86)\\TextFortress\\common\\Decrypt_keys.txt"
        valid_key = False
...
def verify_key():
    key = key_entry.get()
    keypath = r"C:\Program Files (x86)\\TextFortress\\common\\Decrypt_keys.txt"
    valid_key = False
