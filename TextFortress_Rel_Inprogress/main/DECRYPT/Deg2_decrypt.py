...
binary_file_path = "C:\\Program Files (x86)\\TextFortress\\DECRYPT\\Deg2BinRep.txt"
...
decryption_file_path = "C:\\Program Files (x86)\\TextFortress\\DECRYPT\\Deg2gen_DecryptedWord.txt"
